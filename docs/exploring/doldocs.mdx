...
| Key               | Explaination                                                                    |
| ------------------- | --------------------------------------------------------------------------------- |
| `CTRL+Left/Right` | jump to the beginning or end of the current line.                               |
| `CTRL+F`          | find; type something in and press escape to execute. You can also find/replace. |
| `CTRL+T`          | view plaintext of the DolDoc; very useful for formatting.                       |
| `CTRL+L`          | inserts a command/widget into the document. Experiment with this one!           |
