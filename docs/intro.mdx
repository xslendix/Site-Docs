...
# Introduction
[The Temple Operating System](https://www.templeos.org/) is a biblically inspired lightweight, ring-zero operating system (OS) that represents the prophesied Third Temple. GRFGDFVGFDFGDFC
